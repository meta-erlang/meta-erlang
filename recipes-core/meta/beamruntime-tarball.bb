DESCRIPTION = "A SDK type target for running a standalone tarball containing Erlang/OTP and Elixir. The \
               tarball can be used to run Erlang and Elixir application on target systems which don't Erlang/OTP and/or Elixir installed."
SUMMARY = "A SDK type target for running a standalone tarball containing Erlang/OTP and Elixir"
LICENSE = "MIT"
...
SDK_PACKAGE_ARCHS += "beamruntime-dummy-${SDKPKGSUFFIX}"
